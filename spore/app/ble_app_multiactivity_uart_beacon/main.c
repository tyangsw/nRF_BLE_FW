...
#define DEVICE_NAME                     "K_UX"                               /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME               "KarmaMobility"
...
static void nus_data_handler(ble_nus_t * p_nus, uint8_t * p_data, uint16_t length)
{
	...
	{
			err_code = ble_nus_string_send(&m_nus, beacon_uuid, sizeof(beacon_uuid));
...
#else
	SEGGER_RTT_printf(0,"nus data=%x, len=%x",p_data,length);
#endif
}
/**@snippet [Handling the data received over BLE] */
...
static void services_init(void)
{
    ...
    APP_ERROR_CHECK(err_code);
		...
		/*@@TY Initialize Device Information Service.*/
...
static void advertising_init(void)
{
    ...
    advdata.name_type          = BLE_ADVDATA_FULL_NAME;
		...
		/*@@TY change from limited discovery mode to
		*	general discovery mode (alway in disocvery mode as long as its powered)
		*/
...
int main(void)
{
    ...
    APP_TIMER_INIT(APP_TIMER_PRESCALER, APP_TIMER_OP_QUEUE_SIZE, false);
		/*@@TY Config Power BTN GPIO config*/
		btn_gpio_config();
		//uart_init();
